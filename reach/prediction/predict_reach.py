...
def extract_segments_from_csv(csv_path, distance_threshold=3, min_ticks=10):
    """
...
def predict_reach(model_path, input_csv, threshold=0.75, distance_threshold=3, min_ticks=10):
    """
...
if __name__ == "__main__":
    ...
    model_file = os.path.join(base_path, "model", "reach_detect_672_model_2025-03-09_13-37-52.joblib")  # 示例
    test_csv = "/Users/pengyue/Documents/GitHub/MagicShield/reach/data/original_csv/normal/netease960524a8/17807926.csv"
    # test_csv = os.path.join(base_path, "data", "original_csv", "hack", "netease7e491a09", "20810041.csv")  # 一个完整回放
    predict_reach(model_file, test_csv, threshold=0.75, distance_threshold=3, min_ticks=10)
